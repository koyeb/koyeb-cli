...
func (o *GetCatalogServiceOK) Error() string {
	return fmt.Sprintf("[GET /v1/public/catalog/services/{id}][%d] getCatalogServiceOK  %+v", 200, o.Payload)
}
...
func (o *GetCatalogServiceBadRequest) Error() string {
	return fmt.Sprintf("[GET /v1/public/catalog/services/{id}][%d] getCatalogServiceBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetCatalogServiceForbidden) Error() string {
	return fmt.Sprintf("[GET /v1/public/catalog/services/{id}][%d] getCatalogServiceForbidden  %+v", 403, o.Payload)
}
...
func (o *GetCatalogServiceNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/public/catalog/services/{id}][%d] getCatalogServiceNotFound  %+v", 404, o.Payload)
}
