...
func (o *ListCatalogServiceIntegrationsMixin0OK) Error() string {
	return fmt.Sprintf("[GET /v1/public/catalog/services/{id}/integrations][%d] listCatalogServiceIntegrationsMixin0OK  %+v", 200, o.Payload)
}
...
func (o *ListCatalogServiceIntegrationsMixin0BadRequest) Error() string {
	return fmt.Sprintf("[GET /v1/public/catalog/services/{id}/integrations][%d] listCatalogServiceIntegrationsMixin0BadRequest  %+v", 400, o.Payload)
}
...
func (o *ListCatalogServiceIntegrationsMixin0Forbidden) Error() string {
	return fmt.Sprintf("[GET /v1/public/catalog/services/{id}/integrations][%d] listCatalogServiceIntegrationsMixin0Forbidden  %+v", 403, o.Payload)
}
...
func (o *ListCatalogServiceIntegrationsMixin0NotFound) Error() string {
	return fmt.Sprintf("[GET /v1/public/catalog/services/{id}/integrations][%d] listCatalogServiceIntegrationsMixin0NotFound  %+v", 404, o.Payload)
}
