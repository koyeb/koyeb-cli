...
func (o *ListCatalogServiceIntegrationsBadRequest) Error() string {
	return fmt.Sprintf("[GET /v1/public/catalog/services/{id}/integrations][%d] listCatalogServiceIntegrationsBadRequest  %+v", 400, o.Payload)
}
...
func (o *ListCatalogServiceIntegrationsForbidden) Error() string {
	return fmt.Sprintf("[GET /v1/public/catalog/services/{id}/integrations][%d] listCatalogServiceIntegrationsForbidden  %+v", 403, o.Payload)
}
...
func (o *ListCatalogServiceIntegrationsNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/public/catalog/services/{id}/integrations][%d] listCatalogServiceIntegrationsNotFound  %+v", 404, o.Payload)
}
