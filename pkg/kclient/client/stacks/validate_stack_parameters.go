...
func (o *ValidateStackParams) WithBody(body *models.StorageNewStackBody) *ValidateStackParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the validate stack params
func (o *ValidateStackParams) SetBody(body *models.StorageNewStackBody) {
	o.Body = body
}
