...
func (o *ResetPasswordParams) WithBody(body *models.AccountResetPasswordRequest) *ResetPasswordParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the reset password params
func (o *ResetPasswordParams) SetBody(body *models.AccountResetPasswordRequest) {
	o.Body = body
}
