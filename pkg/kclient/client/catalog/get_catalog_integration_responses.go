...
func (o *GetCatalogIntegrationOK) Error() string {
	return fmt.Sprintf("[GET /v1/catalog/integrations/{id}][%d] getCatalogIntegrationOK  %+v", 200, o.Payload)
}
...
func (o *GetCatalogIntegrationBadRequest) Error() string {
	return fmt.Sprintf("[GET /v1/catalog/integrations/{id}][%d] getCatalogIntegrationBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetCatalogIntegrationForbidden) Error() string {
	return fmt.Sprintf("[GET /v1/catalog/integrations/{id}][%d] getCatalogIntegrationForbidden  %+v", 403, o.Payload)
}
...
func (o *GetCatalogIntegrationNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/catalog/integrations/{id}][%d] getCatalogIntegrationNotFound  %+v", 404, o.Payload)
}
