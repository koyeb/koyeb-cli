...
func (o *ListCatalogIntegrationsOK) Error() string {
	return fmt.Sprintf("[GET /v1/catalog/integrations][%d] listCatalogIntegrationsOK  %+v", 200, o.Payload)
}
...
func (o *ListCatalogIntegrationsBadRequest) Error() string {
	return fmt.Sprintf("[GET /v1/catalog/integrations][%d] listCatalogIntegrationsBadRequest  %+v", 400, o.Payload)
}
...
func (o *ListCatalogIntegrationsForbidden) Error() string {
	return fmt.Sprintf("[GET /v1/catalog/integrations][%d] listCatalogIntegrationsForbidden  %+v", 403, o.Payload)
}
...
func (o *ListCatalogIntegrationsNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/catalog/integrations][%d] listCatalogIntegrationsNotFound  %+v", 404, o.Payload)
}
