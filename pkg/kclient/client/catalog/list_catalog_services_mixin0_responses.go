...
func (o *ListCatalogServicesMixin0OK) Error() string {
	return fmt.Sprintf("[GET /v1/catalog/services][%d] listCatalogServicesMixin0OK  %+v", 200, o.Payload)
}
...
func (o *ListCatalogServicesMixin0BadRequest) Error() string {
	return fmt.Sprintf("[GET /v1/catalog/services][%d] listCatalogServicesMixin0BadRequest  %+v", 400, o.Payload)
}
...
func (o *ListCatalogServicesMixin0Forbidden) Error() string {
	return fmt.Sprintf("[GET /v1/catalog/services][%d] listCatalogServicesMixin0Forbidden  %+v", 403, o.Payload)
}
...
func (o *ListCatalogServicesMixin0NotFound) Error() string {
	return fmt.Sprintf("[GET /v1/catalog/services][%d] listCatalogServicesMixin0NotFound  %+v", 404, o.Payload)
}
