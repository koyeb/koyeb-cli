...
func (o *UpdateServiceParams) WithBody(body *models.StorageServiceBody) *UpdateServiceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update service params
func (o *UpdateServiceParams) SetBody(body *models.StorageServiceBody) {
	o.Body = body
}
