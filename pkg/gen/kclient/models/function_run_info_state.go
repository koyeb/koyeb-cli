...
const (
	...
	// FunctionRunInfoStateCANCELLED captures enum value "CANCELLED"
	FunctionRunInfoStateCANCELLED FunctionRunInfoState = "CANCELLED"

	// FunctionRunInfoStateTIMEOUT captures enum value "TIMEOUT"
	FunctionRunInfoStateTIMEOUT FunctionRunInfoState = "TIMEOUT"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["UNKNOWN","STARTING","RUNNING","FAILED","SUCCEEDED","CANCELLED","TIMEOUT"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
