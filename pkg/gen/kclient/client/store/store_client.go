...
type ClientService interface {
	StoreCheckStoreStatus(params *StoreCheckStoreStatusParams, authInfo runtime.ClientAuthInfoWriter) (*StoreCheckStoreStatusOK, error)
...
/*
  StoreCheckStoreStatus store check store status API
*/
func (a *Client) StoreCheckStoreStatus(params *StoreCheckStoreStatusParams, authInfo runtime.ClientAuthInfoWriter) (*StoreCheckStoreStatusOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewStoreCheckStoreStatusParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "store_CheckStoreStatus",
		Method:             "POST",
		PathPattern:        "/v1/stores/{id}/status",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &StoreCheckStoreStatusReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*StoreCheckStoreStatusOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*StoreCheckStoreStatusDefault)
