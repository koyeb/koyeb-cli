...
import (
	...
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/activity"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/catalog"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/connectors"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/credentials"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/functions"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/hooks"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/invite"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/logs"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/organization"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/profile"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/s3_credentials"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/secrets"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/session"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/stack"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/storage_metrics"
	"github.com/koyeb/koyeb-cli/pkg/gen/kclient/client/store"
)

// Default koyeb rest HTTP client.
var Default = NewHTTPClient(nil)

const (
	// DefaultHost is the default Host
	// found in Meta (info) section of spec file
	DefaultHost string = "app.koyeb.com"
...
// NewHTTPClient creates a new koyeb rest HTTP client.
func NewHTTPClient(formats strfmt.Registry) *KoyebRest {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new koyeb rest HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *KoyebRest {
...
// New creates a new koyeb rest client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *KoyebRest {
	// ensure nullable parameters have default
	if formats == nil {
...
// KoyebRest is a client for koyeb rest
type KoyebRest struct {
...
func (c *KoyebRest) SetTransport(transport runtime.ClientTransport) {
