...
- Support `koyeb secret reveal <secret_name>` (or `koyeb secret show <secret_name>`). _The API behind this command is not stable yet and may change in the future. This command can break at any time and will require an update of the CLI._
